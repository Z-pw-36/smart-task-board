    ...
    <div className="page-stack">
      ...
      <div className="inbox-list">
        {inbox.data?.items.map((item) => (
          <article className="inbox-card" key={`${item.action_code}-${item.task.task_id}-${item.node?.node_id || "task"}`}>
